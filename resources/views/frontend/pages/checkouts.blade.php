...
<div class="col-md-5">
    ...
    <p>Total Price with shipping cost: <strong>{{$total_price + App\Models\Setting1::first()->shipping_cost}} Taka</strong></p>
</div>
    </div>
    <p>
    ...
    <div class="card card-body mt-2">
        ...
        <form method="POST" action="{{ route('checkouts.store') }}">
            ...
            <div class="form-group row">
                <label for="message" class="col-md-4 col-form-label text-md-right">Additional {{ __('Message') }} (Optional)</label>

                <div class="col-md-6">
                    <textarea id="message" type="text" class="form-control @error('message') is-invalid @enderror" name="message" rows="4" autocomplete="message" autofocus></textarea>
                    @error('message')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <textarea id="shipping_address" type="text" class="form-control @error('shipping_address') is-invalid @enderror" name="shipping_address" rows="4" autocomplete="shipping_address" autofocus>{{ Auth::check() ? Auth::user()->shipping_address : '' }}</textarea>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    ...
                    @foreach ($payments as $payment)
                            ...
                            <div id="payment_{{$payment->short_name}}" class="alrt alert-success text-center mt-2 hidden">
                            <h3>
                                For cash in there is nothing necessary. Just click finish order.
                            <br>
                            <small>you will get your product in two or three business day</small>
                        </h3>
                        </div>
                    @else 
    ...
    <script type="text/javascript">
        $("#payments").change(function(){
            ...
            if($payment_method=="cash_in"){
                ...
                $("#payment_bkash").addClass('hidden');
                $("#payment_cash_in").addClass('hidden');
                $("#transaction_id").romoveClass('hidden');
            }  
        })
    </script>
@endsection